...
import ar.edu.utn.frba.dds.domain.criterio.CriterioPorFechaCarga;
import ar.edu.utn.frba.dds.domain.criterio.CriterioPorFechaHecho;
import ar.edu.utn.frba.dds.domain.criterio.CriterioPorUbicacion;
...
public class Api {
    ...
    private WebResource agregarQueryParams(WebResource url, List<Criterio> criterios) {
        ...
        } else if (criterios instanceof CriterioPorFechaHecho c) {
