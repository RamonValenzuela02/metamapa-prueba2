...
public class Bootstrap implements WithSimplePersistenceUnit {
  public void init() {
    withTransaction(() -> {
      ...
      SolicitudDeEliminacion s1 = new SolicitudDeEliminacion(h1,"mala redaccion de contenido");
      SolicitudDeEliminacion s2 = new SolicitudDeEliminacion(h2,"ubicacion erronea");
